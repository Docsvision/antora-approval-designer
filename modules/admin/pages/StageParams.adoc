...
** xref:StageParams_reconcilers.adoc#task_lry_2jq_mm__hierarchy_level[Выбрать уровень иерархии руководителя];
** xref:StageParams_reconcilers.adoc#task_lry_2jq_mm__doccard_field[Использовать значение поля документа];
** xref:StageParams_reconcilers.adoc#task_lry_2jq_mm__search_business_process[Использовать бизнес-процесс для вычисления согласующих].
